...
import { obtenerPokemons, obtenerTypes, ordenarPokemonsAZ, ordenarPokemonsFuerza } from "../../redux/actions/pokemonAction";
...
export function Home(){
    ...
    const allPokemons = useSelector((state) => state.arrayPokemons)
    ...
    return (
        ...
        <div className="home">
            ...
            <div>
                <input type="text" onChange={busqueda} placeholder="BUSCAR POKEMON" />
                <button className="buscarpoke"><Link to={`/home/pokemon/${buscar}`} className="buscarlink">BUSCAR</Link></button>
            </div>
